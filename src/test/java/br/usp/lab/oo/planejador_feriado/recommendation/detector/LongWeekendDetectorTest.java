...
class LongWeekendDetectorTest {
    ...
    void shouldDetectFourDayBridgeFromThursdayHoliday() {
        ...
        Holiday holiday = new Holiday(corpusChristi, "Corpus Christi", "Corpus Christi", List.of("Public"));
    ...
    void shouldDetectThreeDayWeekendForFridayHoliday() {
        ...
        Holiday holiday = new Holiday(fridayHoliday, "Labour Day", "Dia do Trabalho", List.of("Public"));
    ...
    void shouldIgnoreSaturdayHolidayWithoutExtraGain() {
        ...
        Holiday holiday = new Holiday(saturday, "Saturday Holiday", "Feriado", List.of("Public"));
    ...
    void shouldDetectBridgeBeforeTuesdayHoliday() {
        ...
        Holiday holiday = new Holiday(tuesday, "Holiday", "Feriado", List.of("Public"));
