...
class DestinationFestivitiesStrategyTest {
    ...
    private final DestinationFestivitiesStrategy strategy = new DestinationFestivitiesStrategy();
    ...
    void scoresHigherWithMoreLocalHolidays() {
        ScoreEntry withFestivities = strategy.evaluate(context(List.of(
                new Holiday(LocalDate.of(2026, 6, 10), "Festa A", "Festa A", List.of("Public")),
                new Holiday(LocalDate.of(2026, 6, 20), "Festa B", "Festa B", List.of("Public")))));
