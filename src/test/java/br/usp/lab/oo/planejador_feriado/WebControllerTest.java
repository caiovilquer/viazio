...
class WebControllerTest {
  ...
  void buscaComCodigoValidoDeveRetornarTemplateResultado() throws Exception {
    when(travelService.getOverviewByQuery("BR")).thenReturn(
      overviewFor("Brazil", "BR")
    );

    mockMvc
      .perform(get("/viagem").param("destino", "BR"))
      .andExpect(status().isOk())
  ...
  @Test
  void buscaComCodigoViaParametroLegadoDeveRetornarTemplateResultado()
    throws Exception {
    when(travelService.getOverviewByQuery("BR")).thenReturn(
      overviewFor("Brazil", "BR")
    );
    ...
    mockMvc
      .perform(get("/viagem").param("codigo", "BR"))
      .andExpect(status().isOk())
      .andExpect(view().name("resultado"))
      .andExpect(model().attributeExists("overview"))
      .andExpect(model().attributeDoesNotExist("erro"));
  ...
  void buscaComNomeValidoDeveRetornarTemplateResultado() throws Exception {
    when(travelService.getOverviewByQuery("brazil")).thenReturn(
      overviewFor("Brazil", "BR")
    );

    mockMvc
      .perform(get("/viagem").param("destino", "brazil"))
      .andExpect(status().isOk())
      .andExpect(view().name("resultado"))
      .andExpect(model().attributeExists("overview"))
      .andExpect(model().attributeDoesNotExist("erro"));
  ...
  void buscaComCodigoInvalidoDeveRetornarErroAmigavel() throws Exception {
    when(travelService.getOverviewByQuery("ZZ")).thenThrow(
      new RuntimeException("Country not found")
    );

    mockMvc
      .perform(get("/viagem").param("destino", "ZZ"))
      .andExpect(status().isOk())
      .andExpect(view().name("resultado"))
  ...
  void buscaComNomeInvalidoDeveRetornarErroAmigavel() throws Exception {
    when(travelService.getOverviewByQuery("pais-inexistente-xyz")).thenThrow(
      new RuntimeException("Country not found")
    );

    mockMvc
      .perform(get("/viagem").param("destino", "pais-inexistente-xyz"))
      .andExpect(status().isOk())
      .andExpect(view().name("resultado"))
      .andExpect(model().attributeExists("erro"))
      .andExpect(model().attributeDoesNotExist("overview"));
  ...
  void buscaComDestinoVazioDeveRetornarMensagemDeErro() throws Exception {
    mockMvc
      .perform(get("/viagem").param("destino", ""))
      .andExpect(status().isOk())
      .andExpect(view().name("resultado"))
      .andExpect(model().attributeExists("erro"));
  }
  ...
  void buscaComCodigoDeveNormalizarTermoBuscado() throws Exception {
    when(travelService.getOverviewByQuery("jp")).thenReturn(
      overviewFor("Japan", "JP")
    );

    mockMvc
      .perform(get("/viagem").param("destino", "jp"))
      .andExpect(status().isOk())
  ...
  void recomendacoesComCountriesValidoDeveRetornarResultado() throws Exception {
    when(recommendationEngine.recommend(any())).thenReturn(
  ...
  void recomendacoesDevePropagarViajantesOrigemEOrcamento() throws Exception {
    ...
    ArgumentCaptor<RecommendationRequest> request = ArgumentCaptor.forClass(
  ...
  @Test
  void recomendacoesComFromMaiorQueToDeveRetornarErroAmigavel()
    throws Exception {
    mockMvc
      .perform(
        get("/recomendacoes")
  ...
  @Test
  void recomendacoesComDatasInvalidasDeveRetornarErroAmigavel()
    throws Exception {
    mockMvc
      .perform(
        get("/recomendacoes")
  ...
  @Test
  void recomendacoesComCountriesERegionDeveRetornarErroAmigavel()
    throws Exception {
    mockMvc
      .perform(
        get("/recomendacoes")
  ...
  @Test
  void recomendacoesComLimiteInvalidoDeveRetornarErroAmigavel()
    throws Exception {
    mockMvc
      .perform(
        get("/recomendacoes")
  ...
  @Test
  void recomendacoesComViajantesOuOrcamentoInvalidosDeveRetornarErroAmigavel()
    throws Exception {
    mockMvc
      .perform(
        get("/recomendacoes")
  ...
  @Test
  void recomendacoesComEngineFalhandoDeveRetornarErroAmigavel()
    throws Exception {
    when(recommendationEngine.recommend(any())).thenThrow(
