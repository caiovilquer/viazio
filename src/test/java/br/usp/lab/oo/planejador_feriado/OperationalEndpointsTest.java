...
class OperationalEndpointsTest {
    ...
    @Test
    void exposesHealthAndPrometheusWithoutSensitiveHealthDetails() throws Exception {
    ...
    @Test
    void correlatesResponseHeaderAndErrorBodyAndAddsSecurityHeaders() throws Exception {
