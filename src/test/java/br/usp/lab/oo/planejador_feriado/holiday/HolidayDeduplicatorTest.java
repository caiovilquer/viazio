...
class HolidayDeduplicatorTest {
    ...
    void shouldRemoveDuplicatesByDateAndName() {
        ...
        Holiday first = new Holiday(date, "Corpus Christi", "Corpus Christi", List.of("Public"));
        Holiday duplicate = new Holiday(date, "Corpus Christi", "Outro nome", List.of("Public"));

        List<Holiday> result = HolidayDeduplicator.deduplicate(List.of(first, duplicate));
    ...
    void shouldKeepDifferentHolidaysOnSameDate() {
        ...
        Holiday christmas = new Holiday(date, "Christmas", "Natal", List.of("Public"));
        Holiday other = new Holiday(date, "Other", "Outro", List.of("Public"));

        List<Holiday> result = HolidayDeduplicator.deduplicate(List.of(christmas, other));
