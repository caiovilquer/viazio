...
@RestController
@RequestMapping("/meta")
@Tag(name = "Metadados", description = "Catálogos e limites necessários para montar clientes da API")
public class ApiMetaController {
    ...
    @GetMapping
    @Operation(summary = "Obtém países, cidades, perfis, critérios, limites e capacidades")
